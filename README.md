...
## 技术栈：
  react + redux + webpack + react-router + react-redux + redux-thunk + styled-components + ES6/7/8 + immutable


## 运行项目（nodejs 6.0+）

```
 git clone https://github.com/ShallowLan/EasyBook.git
...
>  本项目主要用于理解 react 和 redux 的编译方式

>  如果觉得不错的话，您可以点右上角 "Star" 支持一下 谢谢！ ^_^

>  或者您可以 "follow" 一下，我会不断开源更多的有趣的项目

>  开发环境 Windows  Chrome 63  nodejs 8.9.1
